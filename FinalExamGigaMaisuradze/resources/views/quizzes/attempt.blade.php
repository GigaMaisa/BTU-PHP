    ...
    <div id="questions">
        ...
        @foreach ($questions as $question)
            <div class="question" style="display: none">
                ...
                <br>
                <label>
                    <input type="radio" name="answers[{{ $question->question }}]" value="1" onchange="showResult(this, {{ $question->correct_answer }});" answered='false'>
                    {{ $question->answer1 }}
                </label>
                <br>
                <label>
                    <input type="radio" name="answers[{{ $question->question }}]" value="2" onchange="showResult(this, {{ $question->correct_answer }});" answered='false'>
                    {{ $question->answer2 }}
                </label>
                <br>
                <label>
                    <input type="radio" name="answers[{{ $question->question }}]" value="3" onchange="showResult(this, {{ $question->correct_answer }});" answered='false'>
                    {{ $question->answer3 }}
                </label>
                <br>
                <label>
                    <input type="radio" name="answers[{{ $question->question }}]" value="4" onchange="showResult(this, {{ $question->correct_answer }});" answered='false'>
                    {{ $question->answer4 }}
                </label>
                <br>
